    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <p className="text-lg">
          ...
          <ul className="flex flex-col gap-3">
            <li>
              ...
              To solve this problem, I created TECHTRIBE, an online mentorship
              and communication platform to help aspiring developers navigate
        ...
        <div className="mt-5">
          ...
          <p className="pl-9 text-lg">
            My goal is to contribute to innovative and impactful projects in a
            forward-thinking organization where I can collaborate with talented
            professionals, continuously enhance my skills, and develop
            cutting-edge web applications. <br />I aspire to grow as a software
            engineer, staying at the forefront of technology while making
            meaningful contributions to the industry.
          </p>
        </div>

        <div className="mt-15 flex flex-col gap-3">
          <p className="font-semibold flex flex-row gap-3 underline">Feel free to connect with me on: 
            <a target="_blank" href={LINKEDIN_URL} className="hover:rotate-12 duration-300">
            <FaLinkedin size={25}/>
              </a>
            <a target="_blank" href={`mailto:${EMAIL_ID}`} className="hover:rotate-12 duration-300">
              <MdEmail size={25}/>
              </a>
            <a target="_blank" href={GITHUB_URL} className="hover:rotate-12 duration-300">
              <FaGithub size={25}/>
              </a>
            </p>
            <p className="font-semibold flex flex-row gap-3 underline"> Download my resume:
            <a target="_blank" download={true} href="../resume.pdf" className="hover:rotate-y-180"> 
